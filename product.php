			...
			<?php
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">$' . $row['product_offer_price'] . '<del class="product-old-price">$' . $row['product_price'] . '</del></h3>
		...
		<div class="section main main-raised">
			...
			if (mysqli_num_rows($run_query) > 0) {
				...
				while ($row = mysqli_fetch_array($run_query)) {
					...
					$pro_offer_price = $row['product_offer_price'];
					...
					echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$$pro_offer_price<del class='product-old-price'>$$pro_price</del></h4>
										<div class='product-rating'>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
