...
if (isset($_POST['btn_save'])) {
  ...
  if ($picture_type == "image/jpeg" || $picture_type == "image/jpg" || $picture_type == "image/png" || $picture_type == "image/gif") {
    ...
    mysqli_query($con, "insert into products (product_cat, product_brand,product_title,product_offer_price,product_price, product_desc, product_image,product_keywords) values ('$product_type','$brand','$product_name','$offer_price','$price','$details','$pic_name','$tags')") or die("query incorrect");
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" id="price" name="offer_price" required class="form-control">
                  </div>
                </div>
